...
export default function Aboutme() {
  ...
  return (
    <div className=" relative w-full lg:h-5/6 md:h-5/6 mx-10 p-10 flex flex-col md:flex-row items-center justify-center">
      ...
      <div className=" absolute border-2 bottom-0 right-0 w-20 h-20 border-l-0 border-t-0 rounded-br-xl"></div>
        ...
        <div className='w-1/3 m-10 aspect-auto flex items-center justify-center '>
          <img src={Image1} />
        </div>
        <div className='w-2/3 '>
          <div className='flex aspect-auto  items-center justify-center' >
            <div className='text-sm sm:pr-0'>
              ...
              <button className=' text-orange-600 hover:underline'> {">"} more</button>
            </div>
          </div>
        </div>
    </div>
